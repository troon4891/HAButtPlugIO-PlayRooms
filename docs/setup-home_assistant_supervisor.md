...
Official setup guide for running ButtPlug.io PlayRooms as a Home Assistant add-on via the Supervisor.
...
5. Find **ButtPlug.io PlayRooms** in the add-on list and click it
6. Click **Install**
...
## 5. Device Setup (v3.1.0 Device Safety)
