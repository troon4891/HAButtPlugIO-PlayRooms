    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="card text-center max-w-md w-full">
          ...
          <p className="text-slate-400">The host will approve your entry shortly...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen p-4">
      <header className="mb-4">
        <h1 className="text-xl font-bold">{room?.name ?? "Play Room"}</h1>
        <p className="text-sm text-slate-400">Joined as {state.name}</p>
      </header>
